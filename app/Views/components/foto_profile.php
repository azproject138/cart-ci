...
<div class="container mt-4">
    <div class="d-flex justify-content-center">
        <div class="position-relative">
            <img src="<?= base_url('uploads/profile_pictures/' . ($user['profile_picture'] ?? 'default.png')) . '?t=' . time() ?>" alt="Profile Picture" class="rounded-circle" style="width: 100px; height: 100px;">
