        ...
        <div class="form-group">
            <form action="<?= base_url('/pesanan/tambah-pesanan-pengguna'); ?>" method="post">
                ...
                <div class="form-pesanan">
                    <div class="mb-3">
                        <label for="jenisPesanan" class="form-label">Jenis:</label>
                    ...
                    <div class="mb-3">
                        <label for="merekPesanan" class="form-label">Merek:</label>
                    ...
                    <div class="mb-3">
                        <label for="kategoriPesanan" class="form-label">Kategori:</label>
                ...
                <div class="form-ketentuan">
                    ...
                    <div class="mb-3">
                        <label for="tanggal_pesanan" class="form-label">Tanggal:</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="jumlahPesanan" name="jumlah_pesanan" class="input form-control" min="1" required>
                    </div>
                </div>
                ...
                <div class="form-deskripsi">
                    <div class="mb-3">
                        ...
                        <textarea id="deskripsiPesanan" name="deskripsi_pesanan" class="input form-control" rows="3" required></textarea>
                    </div>
                </div>
